			...
			$.ajax({
				...
				success:function( jsonObj ){
					if(jsonObj.resultData){
						$("#idDup")
						.html("<font color='#FF0000'>아이디는 사용중입니다.</font>");
					}else{
						$("#idDupFlag").val(0);
						$("#idDup")
						.html("<font color='#0000FF'>아이디는 사용가능합니다.</font>");
					}
				}
					...
					<th><label for="gender">성별</label></th>
 					<td> 
						<input data-value="성별을 선택하세요."${ wmd.gender eq '1'?" checked='checked'":"" } name="gender" type="radio" id="radio_check01" value="1" /><label for="radio_check01">남자</label>
 						<input name="gender" type="radio" id="radio_check02"${ wmd.gender eq '2'?" checked='checked'":""} value="2"/><label for="radio_check02">여자</label>
 					</td> 
				</tr> 
				<tr>
...
<!-- 						<input  id="area" name="area" class="inputTxt inputName" type="text" /> -->
				...
				<tr>
					...
					<td>
						<input data-value="우편번호를 입력해주세요." value="${ wmd.zicode }" type="text" class="zipcode" id="zipcode" name="zipcode" value=""/>
